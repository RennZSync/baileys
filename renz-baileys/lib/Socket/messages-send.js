...
export const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, isSecret, protected: protectedSend, me: meOnly, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList }) => {
        ...
        const extraAttrs = {};
        if ((isSecret || protectedSend || meOnly) && !isGroup && !isStatus) {
