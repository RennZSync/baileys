...
// Node <biz> WAJIB disertakan pada stanza message yang membawa tombol/list
// (buttonsMessage, listMessage, interactiveMessage/nativeFlowMessage).
// Tanpa node ini server WhatsApp menerima stanza (relayMessage resolve)
// tetapi tidak menyajikan kartu ke client penerima — pesan "terkirim"
// namun tidak dirender. Ini root cause kartu menu tidak muncul.
